...
import { ensureBrowser, getDebuggerWebSocketUrl, connectToExistingBrowser } from "../browser/connection.js";
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (name) {
            case "puppeteer_connect_active_tab":
                try {
                    const wsEndpoint = yield getDebuggerWebSocketUrl(args.debugPort);
                    const connectedPage = yield connectToExistingBrowser(wsEndpoint, args.targetUrl, (logEntry) => {
                        state.consoleLogs.push(logEntry);
                        notifyConsoleUpdate(server);
                    });
                    const url = yield connectedPage.url();
                    const title = yield connectedPage.title();
                    return {
                        content: [{
                                type: "text",
